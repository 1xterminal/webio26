            ...
            <div className={`flex-1 pl-14 md:pl-0 w-full transition-all duration-[600ms] ease-[cubic-bezier(0.16,1,0.3,1)] ${isPassed ? 'opacity-90' : 'opacity-100'}`}>
                {index === 0 ? (
                    <div className={`relative p-6 md:p-8 rounded-[2rem] bg-black/60 backdrop-blur-3xl border border-[#A856EE]/40 overflow-hidden group/card hover:-translate-y-2 hover:scale-[1.02] transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] ${index % 2 === 0 ? 'md:items-end text-left md:text-right md:ml-auto' : 'items-start text-left'} flex flex-col max-w-lg`}
                        ...
                        <div className="mt-4 sm:mt-6 flex flex-col sm:flex-row items-start justify-between gap-4 p-4 sm:p-5 rounded-2xl bg-white/5 border border-[#A856EE]/30 w-full relative z-10 group/subevent hover:bg-white/10 transition-all duration-300 backdrop-blur-sm shadow-[0_0_15px_rgba(168,86,238,0.05)]">
                            <div className="flex flex-col gap-2 items-start text-left w-full sm:flex-1">
                                {/* Top Line: Date and Event Name */}
                                <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                                    <div className="flex items-center gap-2 border border-[#A856EE]/20 bg-[#A856EE]/10 px-2 py-0.5 rounded-full">
                                        <div className="w-1.5 h-1.5 rounded-full bg-[#A856EE] animate-pulse shadow-[0_0_8px_#A856EE]" />
                                        <span className="text-[9px] font-raela font-black uppercase tracking-[0.2em] text-[#A856EE] leading-none">9 Apr 2026</span>
                                    </div>
                                    <span className="font-raela font-bold text-white text-[13px] sm:text-sm tracking-wide">Business Case Release</span>
                                </div>
                                
                                {/* Bottom Block: Description Info */}
                                <div className="flex flex-col gap-0.5 mt-1">
                                    <span className="text-[#A856EE] font-raela text-[10px] sm:text-xs font-bold uppercase tracking-wider">
                                        Official Case Collaborator
                                    </span>
                                    <span className="text-white/80 font-raela text-xs font-medium max-w-[280px]">
