        ...
        <div className="w-full max-w-5xl">
            ...
            >
              ...
              <div
                ...
                style={{ background: `radial-gradient(circle at 100% 0%, #A856EE 0%, transparent 80%)` }}
              />
              ...
              <div
                ...
                style={{
                  padding: '1px',
                  background: `linear-gradient(135deg, #A856EE90 0%, rgba(255,255,255,0.05) 100%)`,
              ...
              <div
                ...
                style={{ boxShadow: `inset 0 0 40px #A856EE15, 0 10px 40px 0 #A856EE25` }}
              />

              <div className="mb-6 group-hover:scale-110 transition-transform duration-300">
                <Sparkles className="w-16 h-16 md:w-20 md:h-20 text-neon-purple drop-shadow-[0_10px_20px_rgba(0,0,0,0.5)]" />
              </div>


              <h3 className="font-raela font-bold text-2xl lg:text-3xl text-white mb-3 leading-tight uppercase">Partner With Us</h3>
              <p className="text-white/50 text-sm leading-relaxed mb-6">
                Jadilah bagian dari perjalanan inovasi kami. Tingkatkan visibilitas brand Anda di I/O Festival 2026.
              </p>

              <div className="mt-auto pt-6">
                <div className={`relative inline-flex items-center gap-2 px-6 py-3 rounded-full font-bold text-sm tracking-wide text-white overflow-hidden group/btn shadow-[0_0_20px_rgba(0,0,0,0.5)] transition-transform duration-[400ms] ease-[cubic-bezier(0.16,1,0.3,1)] hover:scale-105 hover:shadow-[0_0_30px_#A856EE40] transform-gpu`}>
                  <div className={`absolute inset-0 bg-gradient-to-r from-neon-purple to-purple-600 opacity-90 group-hover/btn:opacity-100 transition-opacity duration-[400ms] ease-out translate-z-0`} />
                  ...
                  <span className="relative z-10 flex items-center gap-2 drop-shadow-md">
                    Become a Sponsor <ArrowRight className="w-4 h-4 group-hover/btn:translate-x-1 transition-transform" />
                  </span>
                </div>
              </div>
            </Link>
