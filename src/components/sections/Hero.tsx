  ...
  return (
    <section className="relative min-h-screen flex items-center">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none" style={{ isolation: 'isolate' }}>
        ...
        {/* Static 3D Elements */}
        {/* Top left cluster */}
        <Image src="/assets/element/ELEMEN%202.png" alt="" width={320} height={320} sizes="(max-width:768px) 25vw, (max-width:1024px) 256px, 320px" className="absolute top-[2%] left-[2%] w-[25vw] md:w-64 lg:w-80 opacity-40 md:opacity-60 object-contain rotate-12" priority />
        ...
        {/* Top right cluster */}
        <Image src="/assets/element/ELEMEN%205.png" alt="" width={288} height={288} sizes="(max-width:768px) 20vw, (max-width:1024px) 192px, 288px" className="absolute top-[5%] right-[2%] w-[20vw] md:w-48 lg:w-72 opacity-40 md:opacity-60 object-contain -rotate-6" priority />
        ...
        {/* Bottom left cluster */}
        <Image src="/assets/element/ELEMEN%207.png" alt="" width={256} height={256} sizes="(max-width:768px) 20vw, (max-width:1024px) 224px, 256px" className="absolute bottom-[2%] left-[3%] w-[20vw] md:w-56 lg:w-64 opacity-30 md:opacity-50 object-contain rotate-30" priority />
        ...
        <Image src="/assets/element/ELEMEN%20%208.png" alt="" width={320} height={320} sizes="(max-width:768px) 30vw, (max-width:1024px) 288px, 320px" className="absolute bottom-[5%] right-[2%] w-[30vw] md:w-72 lg:w-80 opacity-40 md:opacity-60 object-contain -rotate-12" priority />
